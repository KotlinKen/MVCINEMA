...
#pageBar span{display:inline-block; background:#ececec; padding:10px; width:67px;  margin-left:10px; }
...
button.updateend, button.cancel{
    padding: 10px;
    font-size: 12px;
}
span#star2{
...
<div class="loginBox">
	...
	<div class="inputer_wrap">
		...
		<div class="btn_section">
			<button class="cancle_btn" onclick="location.href='/cinema'">취소</button>
