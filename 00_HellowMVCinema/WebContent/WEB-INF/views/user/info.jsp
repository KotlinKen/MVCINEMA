...
<style>
#cinema_container *{box-sizing: border-box; outline:none; overflow:hidden;}
#cinema_container{background:#fff; padding:0px;}
#cinema_container table{width:300px; float:left; border-collapse: collapse; padding:0p; border-top:3px solid #1986ff; background:#fff;}
...
#cinema_container table th{width:100px; }
...
#cinema_container .submit_tr input{width:100px; }
#cinema_container .submit_tr .cancle_btn{background:#ddd; color:#898989;}
		...
		<table>
			...
			<tr class="submit_tr">
				<td colspan="9" style="text-align:center">
					<input type="button" class="cancle_btn" value="취소하기">
