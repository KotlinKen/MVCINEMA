...
$("#btn").click(function(){
	...
	var movie = null;
	$.ajax({
		url : "http://www.kobis.or.kr/kobisopenapi/webservice/rest/movie/searchMovieList.json?key=a359d22f05901cbb5c435f8ec69dd00c&curPage=1&itemPerPage=1000&movieNm="+keyword,
